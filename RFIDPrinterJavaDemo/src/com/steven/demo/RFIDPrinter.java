...
public class RFIDPrinter {
    ...
    public void init(String printerURI){
    	...
    	if(printService == null){
    		System.out.println("未找到打印机["+printerURI+"]");
    		//循环列出所有可用打印机
    		if(services != null && services.length > 0){
    			System.out.print("可用的打印机列表：[");
    		...
    		System.out.println("找到打印机！\t["+printerURI+":"+printService.getAttribute(PrinterName.class).getValue()+"]");
    	}
    ...
    public boolean print(String zpl){
    	if(printService == null){
    		System.out.println("打印出错！未找到打印机:["+printerURI+"]");
    		return false;
    	}
